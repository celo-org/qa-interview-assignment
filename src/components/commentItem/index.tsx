  ...
  return (
    <View>
      ...
      >
        ...
        <Text
          numberOfLines={
            props.linesType == "multilines" ? props.numberOfLines : 1
          }
          style={Object.assign({}, styles.commentRow, {
            marginLeft: props.context !== "Home" ? 23 : 0,
          })}
        >
        ...
        <View>
          ...
          <View style={{ marginLeft: 30 }}>
            ...
            >
              ...
              >
                <Text style={styles.author}>@ReplyGuy</Text>
                {` ${Math.random() > 0.5 ? "So true!" : "Facts"}`}
              </Text>
            </View>
            <View style={styles.cardStatsCounter}>
              <View
                style={Object.assign({}, styles.flexStartAligned, { flex: 7 })}
              >
                <Text style={styles.hour}>7h</Text>
                <Text style={styles.likes}>12 Likes</Text>
                <TouchableOpacity>
